(function() {
    var isSubdir = window.location.pathname.indexOf('/shop/') !== -1;
    var prefix = isSubdir ? '../' : '';
    ...
    function createMenu() {
        ...
        var pages = [
            { href: prefix + 'index.html', text: 'Главная', icon: 'fa-home' },
            { href: prefix + 'all.html', text: 'Все проекты', icon: 'fa-th-large' },
            { href: prefix + 'about.html', text: 'О компании', icon: 'fa-info-circle' },
            { href: prefix + 'contacts.html', text: 'Контакты', icon: 'fa-envelope' },
            { href: prefix + 'shop/shop.html', text: 'Магазин', icon: 'fa-shopping-bag' }
        ];
        ...
        themeLi.className = 'sidebar__divider';
        ...
        mobileThemeLi.innerHTML =
            '<div class="theme-switch">' +
                ...
                '<label class="switch"><input type="checkbox" id="themeToggleMobile"><span class="slider"></span></label>' +
            '</div>';
